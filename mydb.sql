...
CREATE TABLE `Clients` (
  ...
  `subcategory_id` int(11) DEFAULT NULL COMMENT 'Reference to subcategory in SubCategory table'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `commission_configs` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Commission tier configurations for sales reps';
...
--
-- Table structure for table `daily_commissions`
--
...
CREATE TABLE `daily_commissions` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Daily commission records for sales reps';
...
CREATE TABLE `offers` (
  ...
  `discount_percentage` decimal(5,2) GENERATED ALWAYS AS (case when `regular_price` > 0 then round((`regular_price` - `offer_price`) / `regular_price` * 100,2) else 0 end) STORED,
...
CREATE TABLE `SalesRep` (
  ...
  `role` varchar(191) DEFAULT 'SALES_REP',
...
--
-- Table structure for table `SalesRepJourneyPlans`
--

CREATE TABLE `SalesRepJourneyPlans` (
  `id` int(11) NOT NULL,
  `sales_rep_id` int(11) NOT NULL,
  `client_id` int(11) NOT NULL,
...
CREATE TABLE `sales_orders` (
  ...
  `recipient_name` varchar(255) DEFAULT NULL COMMENT 'Name of the person who received the delivered order'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `UpliftSaleItem` (
  ...
  `original_price` double(11,2) NOT NULL,
...
ALTER TABLE `Clients`
  ...
  ADD KEY `idx_clients_discount` (`id`,`discountPercentage`),
  ADD KEY `idx_clients_status` (`status`),
  ADD KEY `idx_clients_location` (`region_id`,`route_id`),
  ADD KEY `idx_clients_name` (`name`),
  ADD KEY `idx_clients_id_discount` (`id`,`discountPercentage`);
...
ALTER TABLE `ClientStock`
  ...
  ADD KEY `idx_clientstock_client_product` (`clientId`,`productId`),
  ADD KEY `idx_clientstock_product` (`productId`),
  ADD KEY `idx_clientstock_salesrep` (`salesrepId`);
...
--
-- Indexes for table `commission_configs`
--
ALTER TABLE `commission_configs`
  ...
  ADD KEY `idx_is_active` (`is_active`),
  ADD KEY `idx_commission_configs_active` (`is_active`,`min_amount`);
...
--
-- Indexes for table `daily_commissions`
--
ALTER TABLE `daily_commissions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_daily_commission` (`sales_rep_id`,`commission_date`),
  ADD KEY `idx_sales_rep_id` (`sales_rep_id`),
  ADD KEY `idx_commission_date` (`commission_date`),
  ADD KEY `idx_status` (`status`),
  ADD KEY `idx_commission_tier` (`commission_tier`),
  ADD KEY `idx_daily_commissions_period` (`sales_rep_id`,`commission_date`,`status`),
  ADD KEY `idx_daily_commissions_summary` (`sales_rep_id`,`status`,`commission_amount`);
...
ALTER TABLE `JourneyPlan`
  ...
  ADD KEY `idx_journeyplan_user_date` (`userId`,`date`),
  ADD KEY `idx_journeyplan_user_status` (`userId`,`status`),
  ADD KEY `idx_journeyplan_date_status` (`date`,`status`),
  ADD KEY `idx_journeyplan_client` (`clientId`);
...
ALTER TABLE `LoginHistory`
  ...
  ADD KEY `idx_loginhistory_user_status` (`userId`,`status`),
  ADD KEY `idx_loginhistory_session` (`sessionStart`,`sessionEnd`);
...
ALTER TABLE `offers`
  ...
  ADD KEY `idx_is_active` (`is_active`),
  ADD KEY `offers_ibfk_3` (`created_by`);
...
ALTER TABLE `outlet_quantity_transactions`
  ...
  ADD KEY `idx_outlet_transactions_client_product_date` (`clientId`,`productId`,`transactionDate`),
  ADD KEY `idx_outlet_transactions_client_type` (`clientId`,`transactionType`),
  ADD KEY `idx_outlet_transactions_reference` (`referenceId`,`referenceType`);
...
ALTER TABLE `products`
  ...
  ADD KEY `idx_products_active_category` (`is_active`,`category_id`),
...
ALTER TABLE `SalesRep`
  ...
  ADD KEY `idx_salesrep_phone_status` (`phoneNumber`,`status`),
  ADD KEY `idx_salesrep_location` (`countryId`,`region_id`,`route_id`),
  ADD KEY `idx_salesrep_status` (`status`);

--
-- Indexes for table `SalesRepJourneyPlans`
--
...
ALTER TABLE `sales_orders`
  ...
  ADD KEY `created_by` (`created_by`),
  ADD KEY `idx_sales_orders_recipient_name` (`recipient_name`),
  ADD KEY `idx_orders_user_status` (`created_by`,`status`),
  ADD KEY `idx_orders_client_status` (`client_id`,`status`),
...
ALTER TABLE `sales_order_items`
  ...
  ADD KEY `product_id` (`product_id`),
  ADD KEY `idx_so_items_order_tester` (`sales_order_id`,`is_tester`);
...
ALTER TABLE `stores`
  ...
  ADD KEY `idx_stores_country` (`country_id`);
...
ALTER TABLE `store_inventory`
  ...
  ADD KEY `product_id` (`product_id`),
  ADD KEY `idx_store_inventory_product` (`product_id`,`quantity`),
  ADD KEY `idx_store_inventory_store` (`store_id`),
  ADD KEY `idx_store_inventory_quantity` (`quantity`),
  ADD KEY `idx_store_inventory_product_quantity` (`product_id`,`quantity`);
...
ALTER TABLE `SubCategory`
  ...
  ADD KEY `idx_subcategory_name` (`name`),
  ADD KEY `idx_subcategory_category_id` (`category_id`);
...
ALTER TABLE `Token`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_83660daa3caf1542e35f74a23d1` (`salesRepId`);
...
ALTER TABLE `UpliftSale`
  ...
  ADD KEY `idx_upliftsale_user_status` (`userId`,`status`),
  ADD KEY `idx_upliftsale_client_status` (`clientId`,`status`),
  ADD KEY `idx_upliftsale_created` (`createdAt`),
  ADD KEY `idx_upliftsale_status` (`status`);
...
ALTER TABLE `UpliftSaleItem`
  ...
  ADD KEY `idx_upliftsaleitem_sale_product` (`upliftSaleId`,`productId`),
  ADD KEY `idx_upliftsaleitem_product` (`productId`);
...
--
-- AUTO_INCREMENT for table `commission_configs`
--
ALTER TABLE `commission_configs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `daily_commissions`
--
ALTER TABLE `daily_commissions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `SalesRepJourneyPlans`
--
ALTER TABLE `SalesRepJourneyPlans`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `daily_commissions`
--
ALTER TABLE `daily_commissions`
  ADD CONSTRAINT `fk_daily_commissions_sales_rep` FOREIGN KEY (`sales_rep_id`) REFERENCES `SalesRep` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `LoginHistory`
--
ALTER TABLE `LoginHistory`
  ADD CONSTRAINT `fk_login_salesrep` FOREIGN KEY (`userId`) REFERENCES `SalesRep` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `NoticeBoard`
--
ALTER TABLE `NoticeBoard`
  ADD CONSTRAINT `NoticeBoard_ibfk_1` FOREIGN KEY (`country_id`) REFERENCES `Country` (`id`);
...
ALTER TABLE `offers`
  ...
  ADD CONSTRAINT `offers_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `offers_ibfk_3` FOREIGN KEY (`created_by`) REFERENCES `staff` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `SalesRepJourneyPlans`
--
ALTER TABLE `SalesRepJourneyPlans`
  ADD CONSTRAINT `SalesRepJourneyPlans_ibfk_1` FOREIGN KEY (`sales_rep_id`) REFERENCES `SalesRep` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `SalesRepJourneyPlans_ibfk_2` FOREIGN KEY (`client_id`) REFERENCES `Clients` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `SubCategory`
  ADD CONSTRAINT `SubCategory_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `outlet_categories` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `Token`
  ADD CONSTRAINT `FK_83660daa3caf1542e35f74a23d1` FOREIGN KEY (`salesRepId`) REFERENCES `SalesRep` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
COMMIT;
